...
class NCConnectServer extends StatefulWidget {
  const NCConnectServer({super.key});

  @override
  State<NCConnectServer> createState() => _NCConnectServerState();
}

class _NCConnectServerState extends State<NCConnectServer> {
