...
class _NCLocationState extends State<NCLocation> {
 ...
 // late TextEditingController _searchController;
  ...
  List<String> optionList = ['level 1', 'level 2','level 3', 'level 4','level 5'];
  List<TextEditingController> controllres = List.generate(6, (_) => TextEditingController());
  int visiblefields =1;
                              ...
                              child: Expanded(
                                child: TypeAheadFormField(
                                  ...
                                  onSuggestionSelected: (suggestion) {
                                    setState(() {
                                      controllres[index].text = suggestion;
                    ...
                    TypeAheadFormField(
                      ...
                      itemBuilder: (context, suggestion){
                        return Container(
                          width: MediaQuery.of(context).size.width,
                          margin: EdgeInsets.only(top:20,bottom: 10),
                          child: Text(suggestion[index]['lists'],
                            style: TextStyle(
                              color: Color(0xFFA7A9B7),
                              fontSize: 14,
                              fontFamily: 'Poppins Medium',
                      ...
                      suggestionsCallback: (pattern) {
                        ...
                        //     .toLowerCase().contains(pattern.toLowerCase())).toList();
                        return fieldLists
                            .where((list) => list[index]['lists']
                            .toLowerCase().contains(pattern.toLowerCase())).toList();

                      },
                      onSuggestionSelected: ( suggestion) {
                        setState(() {
                          option1 = suggestion[index]['lists'];
                          //   fieldLists[index]['selectedValue'] = suggestion;

                          print(suggestion[index]['lists']);
                          // if (index != fieldLists.length-1) {
                          // fieldLists[index+1]['isSelected'] = true;
                          //  }
                        });
