...
class EHSLocScreen extends StatefulWidget {


  late ValueChanged<bool> onChange;

  EHSLocScreen({super.key, required this.onChange});

  @override
  State<EHSLocScreen> createState() => _EHSLocScreenState();
}

class _EHSLocScreenState extends State<EHSLocScreen> {
