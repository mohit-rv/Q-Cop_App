...
class EHSReportScreen extends StatefulWidget {
  const EHSReportScreen({super.key});

  @override
  State<EHSReportScreen> createState() => _EHSReportScreenState();
}

class _EHSReportScreenState extends State<EHSReportScreen> {
      ...
      child: Container(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Row(//mainAxisAlignment: MainAxisAlignment.spaceAround,
              children: [
                ...
                Container(
                  ...
                  alignment: Alignment.center,
                  decoration: ShapeDecoration(
                    color: reportLists[index]['reportType'].toString() == "issued" ? Color(0xFFFE69B3) : Color(0xFF15C059),
                    shape: RoundedRectangleBorder(
            ...
            Container(
              margin: EdgeInsets.only(left: 18,top: 10,right: 20),
              child: Text(
                  "Weilding Permit",
                  style:TextStyle(
                    fontSize :13,
