...
class EHSCategoryScreen extends StatefulWidget {

  late ValueChanged<bool> onChange;
  EHSCategoryScreen({super.key, required this.onChange});

  @override
  State<EHSCategoryScreen> createState() => _EHSCategoryScreenState();
}

class _EHSCategoryScreenState extends State<EHSCategoryScreen> {
 ...
 // late TextEditingController _intController;
  ...
  List<dynamic> ehscategorySearchList = [
    "EHScategorysearch1",
    "EHScategorysearch0",
    "EHScategorysearch3",
    "EHScategorysearch2",
    ...
    return Container(
      ...
      child: TypeAheadFormField(
        ...
        suggestionsCallback: (pattern) {
          return ehscategorySearchList.where((list) => list
