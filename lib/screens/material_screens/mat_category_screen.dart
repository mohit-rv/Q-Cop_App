...
class _MatCategoryScreenState extends State<MatCategoryScreen> {
  ...
  List<dynamic> matcategorySearchList = [
    "MATCategorySresult",
    "MATCategorySresult1",
    "MATCategorySresult12",
    "MATCategorySresult123",
    "MATCategorySresult12",
    "MATCategorySresult0",
    "MATCategorySresult0",
  ];
  ...
  List<dynamic> unitList = ["level 1","level 2","level 3","level 4","level 5"];
    ...
    return Container(
      ...
      child: TypeAheadFormField(
        ...
        suggestionsCallback: (pattern) {
          return matcategorySearchList.where((list) => list
          ...
          child: Container(
            ...
            child: Expanded(
              child: TypeAheadFormField(
                ...
                suggestionsCallback: (pattern){
                  return unitList.where((list) => list
                      .toLowerCase().contains(pattern.toLowerCase())).toList();
                },
                onSuggestionSelected: (suggestion) {
                  setState(() {
